...
public class Hooks {
	 ...
	 */
	  ...
	  @Before public void BeforeSteps() { 
	 ...
	 * //Reporter.assignAuthor("Aviet Lobo"); }
	 * 
	 * 
	 ...
	 * the driver at save it to the specified location File sourcePath =
	 * ((TakesScreenshot)
	 * testContext.getWebDriverManager().getDriver()).getScreenshotAs(OutputType.
	 * FILE);
	 * 
